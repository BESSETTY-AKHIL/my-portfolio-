      ...
      <div className="flex space-x-4">
        <div className="relative group">
          <a href="https://www.linkedin.com/in/akhil-bheesetty/" target="_blank" rel="noopener noreferrer">
            <FaLinkedin size={30} className="text-black hover:text-gray-600 transition-all transform group-hover:scale-110" />
          </a>
        ...
        <div className="relative group">
          <a href="https://twitter.com/akhilbheesetty" target="_blank" rel="noopener noreferrer">
            <FaTwitter size={30} className="text-black hover:text-gray-600 transition-all transform group-hover:scale-110" />
          </a>
        ...
        <div className="relative group">
          <a href="https://www.instagram.com/akhil.bheesetty/" target="_blank" rel="noopener noreferrer">
            <FaInstagram size={30} className="text-black hover:text-gray-600 transition-all transform group-hover:scale-110" />
          </a>
